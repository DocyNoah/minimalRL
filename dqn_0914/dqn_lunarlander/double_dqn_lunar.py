...
def main():
    ...
    wandb.run.name = "double_dqn_lunar_{}".format(current_time())
    print(current_time())
    main_time = time.time()
    ...
    for n_epi in range(5000):
        ...
        if n_epi % print_interval == 0 and n_epi != 0:
            ...
            if best_mean_reward < mean_reward:
                torch.save(q.state_dict(), "Double_DQN-best.dat")
    ...
    reward_path = os.path.join(".", "output_data", "double_dqn_reward_{}".format(main_time))
    loss_path = os.path.join(".", "output_data", "double_dqn_loss_{}".format(main_time))
    ...
    # # Test render
    # q.load_state_dict(torch.load("Double_DQN-best.dat"))
    # fps = 60
    #
    # for _ in range(10):
    #     s = env.reset()
